...
def model(train_generator, test_generator, save_model_path='/home/zyj/GarbageClassify/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5',
          log_dir="/home/zyj/GarbageClassify/"):
...
def main():
    # 数据集路径
    data_path = "/home/zyj/GarbageClassify/train_data"
    # 结果储存路径，根据结果可以改一下
    save_model_path = '/home/zyj/GarbageClassify/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5'
